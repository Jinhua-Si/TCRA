...
def SSA(images, gt, model, min, max):
    """
...
def main():
    ...
    for images, images_ID,  gt_cpu in tqdm(data_loader):
        ...
        adv_img = SSA(images, gt, model, images_min, images_max)
        adv_img_np = adv_img.cpu().numpy()
        adv_img_np = np.transpose(adv_img_np, (0, 2, 3, 1)) * 255
        save_image(adv_img_np, images_ID, './incv3_sstl_outputs/')
